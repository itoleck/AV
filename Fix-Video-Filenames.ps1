...
function Fix-FileNames($rootpath) {
    ...
    $replacers = "bigdoc","yify","1080p","720p","x265","h264","x264","sampa","mstm","dimension","ZZZ"," 0vyndros","xvidositv","collector’s","choice","xvidphase","dvdrip","jfkxvid","__dvdripdimension"," extended","bordure","qoq","demand","gwc","esubs","sigma","garshasp","dvdriptabularia","[","]"," Silence)","(",")","gi6-","hdtv","proper","kogi","webdl","web dl","amzn","web","web-dl","atmos","aac2","aac2.0","aac",".internal.",".proper.","rartv","-tbs","-dl","bluray","-deflate","reward","ntb","ntbrarbg","ntbrarbg","ddp5.1","dd5.1","webrip","brrip","repack","-cakes",".cakes","cakesrarbg","elite","ggezrarbg","ntbtgx","rubik",".rip","nf","galaxytv","PECULATE","KOGirarbg","SHORTBREHD","FUMettv","KILLERSettv","-killers","-batv","-sva","hmax","metcon","ion10","rovers","pcok","minx","torrentgalaxy","megusta","-smurf","-truffle","-welp","-fleet","-nosivid","-gossip","dsnp","-turbo","-wdym",".nf.","-avs","mSDeztv","-CRiMSONeztv","-CookieMonstereztv","rarbg"
