...
function Fix-FileNames($rootpath) {
    ...
    $replacers = "bigdoc","mstm","dimension","ZZZ"," 0vyndros","xvidositv","collector’s","choice","xvidphase","dvdrip","jfkxvid","__dvdripdimension"," extended","bordure","qoq","demand","gwc","esubs","sigma","garshasp","dvdriptabularia","[","]"," Silence)","(",")","gi6-","1080p","720p","480p","4120p","hdtv","hevc","proper","kogi","webdl","h264","h.264","h.265","h265","web dl","x265","x.265","x264","x.264","amzn","web","web-dl","atmos","aac2","aac2.0","aac","10bit",".internal.",".proper.","rartv","-tbs","-dl","bluray","-deflate","reward","ntb","ntbrarbg","ntbrarbg","ddp5.1","dd5.1","webrip","brrip","repack","-cakes",".cakes","cakesrarbg","elite","ggezrarbg","ntbtgx","rubik",".rip","nf","galaxytv","PECULATE","KOGirarbg","SHORTBREHD","FUMettv","KILLERSettv","-killers","-batv","-sva","hmax","metcon","ion10","rovers","pcok","minx","torrentgalaxy","megusta","-smurf","-truffle","-welp","-fleet","-nosivid","-gossip","dsnp","-turbo","-wdym",".nf.","-avs","mSDeztv","-CRiMSONeztv","-CookieMonstereztv","rarbg"
